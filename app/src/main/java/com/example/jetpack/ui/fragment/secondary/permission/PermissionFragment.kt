package com.example.jetpack.ui.fragment.secondary.permission

// PLAYGROUND-TAGS: permission, runtime, settings, activity result — see SampleRegistry (Permissions)
