...
import com.example.jetpack.core.base.LocalLocale
...
fun DigitalClock3(
    ...
    Column(
        ...
        Text(text = "$weekday, $day $year", color = textColor, style = customizedTextStyle(fontSize = 16, fontWeight = 600))
    }
}
...
fun PreviewDigitalClock3() {
    ViewUtil.PreviewContent {
        DigitalClock3(modifier = Modifier
            .fillMaxWidth()
